<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kategoriler.aspx.cs" Inherits="LokantaCafeWeb.Admin.Kategoriler" %>
...
<head runat="server">
    ...
    <style type="text/css">
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-row{
            display: grid;
            grid-template-columns: 160px 1fr 110px 1fr 140px;
            gap: 10px;
            align-items: center;
        }
        ...
        /* GridView içindeki edit / delete butonlarını şıklaştırma */
        .data-grid a{
            color: #fde68a;
            text-decoration: none;
            font-weight: 800;
            ...
            <div class="glass topbar">
                <div class="top-left">
                    ...
                    <div class="title-wrap">
                        <div class="title-main">Kategori Yönetimi</div>
                        <div class="title-sub">Menü kategorilerini ekleyin, düzenleyin veya pasif hale getirin.</div>
                    </div>
                </div>
        ...
        Ana Ekran
            ...
            <div class="glass nav">
                ...
                <asp:HyperLink ID="hlKategoriler" runat="server" NavigateUrl="~/Admin/Kategoriler.aspx"
                    CssClass="nav-link nav-link-active">Kategoriler</asp:HyperLink>
            ...
            <div class="glass content">
                ...
                <div class="panel">
                    <div class="section-head">
                        ...
                        <div class="section-subtitle">Müşterilerin göreceği menü gruplarını buradan oluşturabilirsiniz.</div>
                    </div>

                    <div class="form-row">
                        <div class="label">Kategori Adı</div>
                        <asp:TextBox ID="txtYeniKategoriAdi" runat="server" CssClass="text-input"></asp:TextBox>

                        <div class="label">Açıklama</div>
                        <asp:TextBox ID="txtYeniAciklama" runat="server" CssClass="text-input"></asp:TextBox>

                        <asp:Button ID="btnKategoriEkle" runat="server" Text="Ekle"
                            CssClass="btn-primary" OnClick="btnKategoriEkle_Click" />
                    </div>
                </div>

                <!-- Kategori Listesi -->
                <div class="section-head">
                    <div class="section-title">Kayıtlı Kategoriler</div>
                    <div class="section-subtitle">Aktif/pasif durumlarını düzenleyebilir, isimlerini güncelleyebilirsiniz.</div>
                </div>

                <asp:GridView ID="gvKategoriler" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="KategoriId"
                    CssClass="data-grid"
                    OnRowEditing="gvKategoriler_RowEditing"
                    OnRowCancelingEdit="gvKategoriler_RowCancelingEdit"
                    OnRowUpdating="gvKategoriler_RowUpdating"
                    OnRowDeleting="gvKategoriler_RowDeleting">
                    <Columns>
                        <asp:BoundField DataField="KategoriId" HeaderText="ID" ReadOnly="True" />
